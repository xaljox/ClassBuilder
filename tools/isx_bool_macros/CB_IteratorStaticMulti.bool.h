...
\
ClassFrom::NameTo##Iterator::NameTo##Iterator(bool (ClassTo::*method)() const, ClassTo* ref##NameTo)\
{\
    CriticalSectionLock lock(CriticalSection##NameTo(), ClassFrom::IsCritical##NameTo());\
	\
...
\
ClassFrom::NameTo##Iterator::NameTo##Iterator(const NameTo##Iterator& iterator__, bool (ClassTo::*method)() const)\
{\
    CriticalSectionLock lock(CriticalSection##NameTo(), ClassFrom::IsCritical##NameTo());\
	\
    _ref##NameTo = iterator__._ref##NameTo;\
...
\
void ClassFrom::NameTo##Iterator::CheckAll()\
{\
    CriticalSectionLock lock(CriticalSection##NameTo(), ClassFrom::IsCritical##NameTo());\
    for (NameTo##Iterator* item = _first; item; item = item->_next)\
    {\
        item->_ref##NameTo = (ClassTo*)0;\
        item->_prev##NameTo = (ClassTo*)0;\
        item->_next##NameTo = (ClassTo*)0;\
    }\
}
